      ...
      <main className={styles.Main}>
        ...
        <div className={styles.Main}>
            <section className={styles.Container}>
                ...
                <div className={styles.ButtonContainer}>
                    <Link href="/successful-purchase">
                        <Button style="Continue" title="Confirmar compra">Confirmar Compra</Button>
                    </Link>
                </div>
            </section>
          ...
          <ProductShipping
            ...
            description="Reliquia de los antiguos aztecas, encontrada en las ruinas de Tenochtitlán durante investigaciones arqueológicas en 1937. Cráneo bañado en oro y conservado por los museos de historia prehispánica en la Ciudad de México."
            price={19999.97}
            imgUrl="https://http2.mlstatic.com/crazdo-craneo-decorativo-azteca-dorado-artesania-mexicana-D_NQ_NP_954974-MLM31546603590_072019-F.jpg"
            quantity={3}
          />
          <div className={styles.ButtonContainer}>
            <Link href="/successful-purchase">
        ...
        <section className={styles.RightBar}>
          <section className={styles.SummaryContainer}>
            <ShippingSummary
              totalQuantity={2}
              totalPrice={19999.97 * 2}
              shippingCost={5000}
              totalCost={19999.97 * 2 + 5000}
            />
          </section>
        </section>
      </main>
